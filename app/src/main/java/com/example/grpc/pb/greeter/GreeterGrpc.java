...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.pb.greeter.HelloRequest,
      com.example.grpc.pb.greeter.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.example.grpc.pb.greeter.HelloRequest.class,
      responseType = com.example.grpc.pb.greeter.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpc.pb.greeter.HelloRequest,
      com.example.grpc.pb.greeter.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.pb.greeter.HelloRequest, com.example.grpc.pb.greeter.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.example.grpc.pb.greeter.HelloRequest, com.example.grpc.pb.greeter.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.pb.greeter.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.pb.greeter.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(com.example.grpc.pb.greeter.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.pb.greeter.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
    ...
    /**
     */
    public void sayHello(com.example.grpc.pb.greeter.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.pb.greeter.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingStub
    ...
    /**
     */
    public com.example.grpc.pb.greeter.HelloReply sayHello(com.example.grpc.pb.greeter.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.pb.greeter.HelloReply> sayHello(
        com.example.grpc.pb.greeter.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.example.grpc.pb.greeter.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.pb.greeter.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.grpc.pb.greeter.HelloRequest,
              com.example.grpc.pb.greeter.HelloReply>(
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.pb.greeter.GreeterOuterClass.getDescriptor();
    }
